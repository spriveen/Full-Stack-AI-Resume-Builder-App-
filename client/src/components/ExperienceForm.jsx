        ...
        <div className='space-y-4'>
          {data.map((experience, index)=>(
           ...
           <div className='space-y-2'>
            ...
            <textarea value={experience.description || ""} onChange={(e)=>updateExperience(index, "description" , e.target.value )} rows={4} className='w-full text-sm px-3 py-2 rounded-lg

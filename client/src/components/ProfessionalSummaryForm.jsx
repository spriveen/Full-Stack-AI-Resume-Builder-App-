  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='mt-6'>
        ...
        placeholder='Write a compelling professional summary that highligts your
        key strengths and career objetives...'/>
        <p className='text-xs text-gray-500 max-w-4/5 max-w-4/5 mx-auto text-center'>Tip: Keep it concise(3-4 sentence) and focus on your most relevent achivements and skills</p>
    </div>

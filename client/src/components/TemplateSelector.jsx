...
const TemplateSelector = ({selectedTemplate, onChange}) => {
...

    {
         id: "classic",
        name: "Classic",
        preview: "A clean, traditional resume format with clear section and professional typrography"
    },

     {
         id: "modern",
        name: "Modern",
        preview: "A sleek, contemporary resume format with bold design elements and a clean layout"
    },

    {
         id: "minimal-image",
        name: "Minimal Image",
        preview: "A minimalist resume format with a focus on clean lines and subtle image integration"
    },

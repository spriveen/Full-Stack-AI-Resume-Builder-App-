...
const ResumeBuilder = () => {
  ...
  const saveResume = async () => {
    try {
      ...
      removeBackground && formData.append("RemoveBackground", "ÿes")
        ...
        <div className='grid lg:grid-cols-12 gap-8'>
          ...
          <div className='lg:col-span-5 rounded-lg overflow-hidden'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1 '>
              {/* progredd bar using activesectionindex */}
              <hr className='absolute top-0 left-0  border-2 border-gray-200' />
              <hr
          ...
          <div className='lg:col-span-7 max-lg:mt-6'>
            ...
            justify-end gap-2'>
              {resumeData.public && (
                <button onClick={handleShare}  className='flex items-center p-2 gap-2 text-xs

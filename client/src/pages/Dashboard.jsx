     ...
     const editTitle = async (event) => { 
      try {
       ...
       const deleteResume = async (resumeId) => { 
        try {
           const confirm = window.confirm('Are you sre you want to delete this resume?')
     if (confirm) {
        ...
        {allResumes.map((resume,index)=>{
         ...
         return (
          ...
          `, borderColor: baseColor + '40'}}>
             ...
             <div onClick={e=> e.stopPropagation()} className='absolute top-1 
             right-1 group-hover:flex items-center hidden'>
              <TrashIcon onClick={()=> deleteResume(resume._id)} className='size-7
               p-1.5 hover:bg-white/50 rounded text-slate-700 transition-colors' />
     ...
     {showUploadResume &&  (
      ...
      max-w-sm p-6'>
        <h2 className='text-xl font-bold mb-4'>Upload Resume</h2>
         ...
         hover:bg-green-700 transition-colors flexitems-center justify-center gap-2'>
